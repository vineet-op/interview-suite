...
export namespace Prisma {
  ...
  */
  ...
  export type interviewsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"interviewId" | "username" | "role" | "experience" | "jobDescription" | "questions" | "answers" | "aiResponse" | "feedbackResponse" | "createdAt", ExtArgs["result"]["interviews"]>
  ...
  export interface interviewsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const interviewsWithInterviewIdOnly = await prisma.interviews.createManyAndReturn({
     ...
     * const interviewsWithInterviewIdOnly = await prisma.interviews.updateManyAndReturn({
     *   select: { interviewId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface interviewsFieldRefs {
    ...
    readonly username: FieldRef<"interviews", 'String'>
    readonly role: FieldRef<"interviews", 'String'>
    readonly experience: FieldRef<"interviews", 'String'>
    readonly jobDescription: FieldRef<"interviews", 'String'>
    readonly questions: FieldRef<"interviews", 'String[]'>
    readonly answers: FieldRef<"interviews", 'String[]'>
    readonly aiResponse: FieldRef<"interviews", 'String'>
    readonly feedbackResponse: FieldRef<"interviews", 'String'>
  ...
  export type interviewsWhereInput = {
    ...
    username?: StringNullableFilter<"interviews"> | string | null
    role?: StringFilter<"interviews"> | string
    experience?: StringFilter<"interviews"> | string
    jobDescription?: StringFilter<"interviews"> | string
    questions?: StringNullableListFilter<"interviews">
    answers?: StringNullableListFilter<"interviews">
    aiResponse?: StringFilter<"interviews"> | string
    feedbackResponse?: StringNullableFilter<"interviews"> | string | null
  ...
  export type interviewsOrderByWithRelationInput = {
    ...
    feedbackResponse?: SortOrderInput | SortOrder
    createdAt?: SortOrder
  }
  ...
  export type interviewsScalarWhereWithAggregatesInput = {
    ...
    username?: StringNullableWithAggregatesFilter<"interviews"> | string | null
    role?: StringWithAggregatesFilter<"interviews"> | string
    experience?: StringWithAggregatesFilter<"interviews"> | string
    jobDescription?: StringWithAggregatesFilter<"interviews"> | string
    questions?: StringNullableListFilter<"interviews">
    answers?: StringNullableListFilter<"interviews">
    aiResponse?: StringWithAggregatesFilter<"interviews"> | string
    feedbackResponse?: StringNullableWithAggregatesFilter<"interviews"> | string | null
  ...
  export type interviewsCreateInput = {
    ...
    answers?: interviewsCreateanswersInput | string[]
    aiResponse: string
    feedbackResponse?: string | null
  ...
  export type interviewsUpdateInput = {
    ...
    answers?: interviewsUpdateanswersInput | string[]
    aiResponse?: StringFieldUpdateOperationsInput | string
    feedbackResponse?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type interviewsCreateanswersInput = {
    set: string[]
  }
  ...
  export type interviewsUpdateanswersInput = {
    set?: string[]
    push?: string | string[]
  }
